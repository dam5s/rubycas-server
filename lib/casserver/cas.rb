...
# Encapsulates CAS functionality.
module CASServer
  module CAS
    ...
    def generate_login_ticket
      # 3.5 (login ticket)
      lt = LoginTicket.new
      lt.ticket = "LT-" + Utils.random_string
    ...
    def generate_ticket_granting_ticket(username, extra_attributes = {})
      ...
      tgt.ticket = "TGC-" + Utils.random_string
    ...
    def generate_service_ticket(service, username, tgt)
      ...
      st.ticket = "ST-" + Utils.random_string
      st.service = service
    ...
    def generate_proxy_ticket(target_service, pgt)
      # 3.2 (proxy ticket)
      pt = ProxyTicket.new
      pt.ticket = "PT-" + Utils.random_string
    ...
    def generate_proxy_granting_ticket(pgt_url, st)
      ...
      https.start do |conn|
        ...
        pgt.ticket = "PGT-" + Utils.random_string(60)
        pgt.iou = "PGTIOU-" + Utils.random_string(57)
